...
public abstract class Behavior(Delegate implementation, Times? times, int calls)
{
    ...
    public static Behavior<VoidType> Call<
        ...
        T14
    >(
        Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> implementation,
        Times? times = null
    )
    {
        return new Behavior<VoidType>(implementation, times);
    ...
    public static Behavior<VoidType> Call<
        ...
        T15
    >(
        Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> implementation,
        Times? times = null
    )
    {
        return new Behavior<VoidType>(implementation, times);
    ...
    public static Behavior<TOut> Call<
        ...
        TOut
    >(
        Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TOut> implementation,
        Times? times = null
    )
    {
        return new Behavior<TOut>(implementation, times);
    ...
    public static Behavior<TOut> Call<
        ...
        TOut
    >(
        Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TOut> implementation,
        Times? times = null
    )
    {
        return new Behavior<TOut>(implementation, times);
