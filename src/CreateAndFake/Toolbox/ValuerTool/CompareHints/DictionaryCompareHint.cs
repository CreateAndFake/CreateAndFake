...
namespace CreateAndFake.Toolbox.ValuerTool.CompareHints
{
    ...
    public sealed class DictionaryCompareHint : CompareHint<IDictionary>
    {
        ...
        protected override IEnumerable<Difference> Compare(IDictionary expected, IDictionary actual, IValuer valuer)
        {
        ...
        protected override int GetHashCode(IDictionary item, IValuer valuer)
        {
