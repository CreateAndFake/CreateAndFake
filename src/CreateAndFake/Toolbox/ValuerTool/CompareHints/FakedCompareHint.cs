...
namespace CreateAndFake.Toolbox.ValuerTool.CompareHints
{
    ...
    public sealed class FakedCompareHint : CompareHint<IFaked>
    {
        ...
        protected override IEnumerable<Difference> Compare(IFaked expected, IFaked actual, IValuer valuer)
        {
        ...
        protected override int GetHashCode(IFaked item, IValuer valuer)
        {
