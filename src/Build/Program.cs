...
namespace Build
{
    ...
    public static class Program
    {
        ...
        {
            await RunAsync("dotnet", $"build src/CreateAndFake --no-restore --configuration Debug");
            await RunAsync("dotnet", $"build src/CreateAndFake --no-restore --configuration Release");
            await RunAsync("dotnet", $"build tests/CreateAndFakeTests --no-restore --configuration Debug");
            await RunAsync("dotnet", $"build tests/CreateAndFakeTests --no-restore --configuration Release");
        }
