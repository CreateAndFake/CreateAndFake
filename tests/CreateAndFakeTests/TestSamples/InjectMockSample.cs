...
namespace CreateAndFakeTests.TestSamples
{
    ...
    public sealed class InjectMockSample
    {
        /// <summary>For testing.</summary>
        private readonly IOnlyMockSample _sample1, _sample2;

        /// <summary>For testing.</summary>
        public InjectMockSample(IOnlyMockSample sample1, IOnlyMockSample sample2)
        {
