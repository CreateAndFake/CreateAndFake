...
public static class NotNullIfNotNullAttributeTests
{
    private static readonly Type _TestType = Assembly
        .GetAssembly(typeof(ArgumentGuard))
        .GetType("NotNullIfNotNullAttribute");

    [Fact]
    internal static Task NotNullIfNotNullAttribute_GuardsNulls()
    {
    ...
    [Fact]
    internal static Task NotNullIfNotNullAttribute_NoParameterMutation()
    {
        return _TestType == null
            ? Task.CompletedTask
    ...
    [Fact]
    internal static void NotNullIfNotNullAttribute_InternalOnly()
    {
